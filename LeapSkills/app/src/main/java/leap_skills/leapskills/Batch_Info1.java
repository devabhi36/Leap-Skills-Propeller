...
public class Batch_Info1 extends Fragment {
    public static String batch, batch_id, token;
    TextView batch_name;
    TableLayout tb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_batch_info1, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        batch_name = (TextView) view.findViewById(R.id.batch_name1);
        batch_name.setText(batch);
        tb = (TableLayout) view.findViewById(R.id.attendence_table6);

        final Typeface font = ResourcesCompat.getFont(getContext(), R.font.worksans_medium);

        SharedPreferences saved_data = getActivity().getSharedPreferences(PREFS_NAME4, 0);
        ...
        if(length1>0){
            ...
            for (int x = 0; x < length1; x++) {
                ...
                String clg_name = saved_data.getString("Clg_name"+String.valueOf(x), null);
                String stream = saved_data.getString("Stream"+String.valueOf(x), null);
                String pre_assess_level = saved_data.getString("Pre_Assess_Level"+String.valueOf(x), null);
                ...
                row1[x].addView(tv6, LinearLayout.LayoutParams.WRAP_CONTENT, 80);
                ...
                tv7.setText(pre_assess_level);
                tv7.setTextColor(Color.parseColor("#3E7C62"));
                tv7.setTypeface(font);
                row1[x].addView(tv7, LinearLayout.LayoutParams.WRAP_CONTENT, 80);
                ...
                row1[x].addView(tv8, LinearLayout.LayoutParams.WRAP_CONTENT, 80);
            ...
            String arr[] = {"Leap ID", "First Name", "Last Name", "College Name", "Stream", "Pre Ass Level", "Password"};
        ...
        for (int i = 0; i < 1; i++) {
            ...
            for (int j = 0; j < arr.length; j++) {
                ...
                row[i].addView(tv1, 50, 80);
            }
            tb.addView(row[i]);
        }*/

            String url = "http://leap-opa.ap-south-1.elasticbeanstalk.com/batch_student_list/" + batch_id;
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    try {
                        SharedPreferences data = getActivity().getSharedPreferences(PREFS_NAME4, 0);
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            String pre_assess_level = details.getString("pre_assesment_level");
                            ...
                            editor.putString("Clg_name" + String.valueOf(i), clg_name);
                            editor.putString("Stream" + String.valueOf(i), stream);
                            editor.putString("Pre_Assess_Level" + String.valueOf(i), pre_assess_level);
