...
public class Last_Attendence extends Fragment {
    TableLayout tb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_last_attendence, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        submit = (Button) view.findViewById(R.id.slattendence);
        tb = view.findViewById(R.id.lattendence_table);
