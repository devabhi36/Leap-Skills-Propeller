...
public class Student_Info_PM extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_student_info_pm, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tb = (TableLayout) view.findViewById(R.id.attendence_table3);

        final Typeface font = ResourcesCompat.getFont(getContext(), R.font.worksans_medium);

        SharedPreferences saved_data = getActivity().getSharedPreferences(PREFS_NAME2, 0);
        ...
        for (int i = 0; i < 1; i++) {
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    try {
                        SharedPreferences data = getActivity().getSharedPreferences(PREFS_NAME2, 0);
