...
public class TrainerFeedback extends Fragment {
    Spinner subject;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_trainer_feedback, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        subject = (Spinner) view.findViewById(R.id.feedback_optiont);
        submit = (Button) view.findViewById(R.id.trainer_feedback5);
        body = (EditText) view.findViewById(R.id.tfeedback);
